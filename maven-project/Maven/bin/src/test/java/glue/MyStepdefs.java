...
public class MyStepdefs extends Configurations {
    ...
    public void Open_result_page_that_is_linked_to(String arg1) {
        ...
        String a = element1.getCssValue("href");
    ...
    public void I_Select_right_language_to_Polish_and_click_on_Translate_button() throws IndexOutOfBoundsException {
        ...
        element1.click();
       // WebElement element2 = browser.findElement(By.xpath("//div[contains(text(), \"польский\") and @class=\"goog-menuitem-content\"]"));
        //element2.click();
        ...
        for (WebElement checkbox : languages) {
            ...
            String SubStr1 = new String("польский");
